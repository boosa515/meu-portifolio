// ========================
// Este arquivo armazena todos os projetos do portfólio.
// Cada projeto é identificado por um ID único (ex: '1', '2', '3')
// e contém campos multilíngues para títulos, descrições e desafios.
// ========================
...
const projectData = {
    ...
    '1': {
        ...
        // Informações complementares resumidas (tecnologias)
        meta: 'Tecnologias: Python, OpenCV, ESP32, Motores de Passo',

        //Data de conclusão ou publicação do projeto
        date: 'Setembro 2025',

        //Caminho da imagem principal do projeto
        image: 'Imagens/projects/robot_arm.jpg',
        
        //Descrição geral multilíngue do projeto
        overview: {
        ...
        // Lista de desafios encontrados e suas soluções, também multilíngue
        challenges: [
            {
                name: {
                    pt: 'Precisão de Posicionamento',
                    en: 'Positioning Accuracy',
                    zh: '定位精度',
                    ja: '位置決め精度'
                },
                solution: {
                    pt: 'Implementação de controle de micro-passos e calibração via software.',
                    en: 'Implementation of micro-stepping control and software-based calibration.',
                    zh: '实施微步控制和基于软件的校准。',
                    ja: 'マイクロステップ制御とソフトウェアによるキャリブレーションの実装。'
                }
            },
            {
                name: {
                ...
                solution: {
                    pt: 'Otimização dos algoritmos de detecção de bordas e compressão de dados.',
                    en: 'Optimization of edge detection algorithms and data compression.',
                    zh: '优化边缘检测算法和数据压缩。',
                    ja: 'エッジ検出アルゴリズムとデータ圧縮の最適化。'
                }
            }
        ],

        //Links externos — GitHub e vídeo demonstrativo (futuro)
    ...
    '2': {
        ...
        challenges: [
            {
                name: {
                    pt: 'Conectividade e Bateria',
                    en: 'Connectivity and Battery Life',
                    zh: '连接和电池寿命',
                    ja: '接続性とバッテリー寿命'
                },
                solution: {
                    pt: 'Uso de modo Deep Sleep do ESP32 e lógica de reconexão automática ao Wi-Fi.',
                    en: 'Using ESP32 Deep Sleep mode and automatic Wi-Fi reconnection logic.',
                    zh: '使用ESP32深度睡眠模式和自动Wi-Fi重连逻辑。',
                    ja: 'ESP32ディープスリープモードの使用とWi-Fi自動再接続ロジック。'
                }
            }
        ],
    ...
    '3': {
        ...
        challenges: [
            {
                name: {
                    pt: 'Integridade de Sinal',
                    en: 'Signal Integrity',
                    zh: '信号完整性',
                    ja: '信号保全性'
                },
                solution: {
                    pt: 'Utilização de trilhas de impedância controlada e plano de terra sólido sob a antena.',
                    en: 'Use of controlled impedance traces and a solid ground plane under the antenna.',
                    zh: '使用受控阻抗走线和天线下方坚实的接地层。',
                    ja: '制御されたインピーダンス配線とアンテナ下の強固なグランドプレーンの使用。'
                }
            }
        ],
